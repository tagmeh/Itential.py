...
# from tests.mocks.utils import get_test_path
#
#
...
#     @classmethod
#     def setUpClass(cls):
#         test_path = get_test_path(__file__)
#
#         # itential2021_1 = Itential2021_1("username", "password", "https://itential-instance-url.com")
#         # cls.workflow_asset = WorkflowModel2021_1(itential2021_1)
#
...
#         workflow = WorkflowModel2021_1(**workflow_json)
#
...
#         # Test Response
#         self.assertIsInstance(workflows, list)
#         self.assertIsInstance(workflows[0], WorkflowModel2021_1, "The object in the list should be a WorkflowModel2021_1 object.")
...
#         }
#
#         job = Job2021_1(**{"itential_instance": self.itential2021_1}, **self.get_job_by_id_response_json)
#
#         # Call get_workflow method
