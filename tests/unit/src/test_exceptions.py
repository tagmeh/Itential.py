...
from itential.src.exceptions import NotSupportedError, ApiError
...
class TestAuth(unittest.TestCase):
    ...
    def test_ApiError(self):
        ...
        self.assertEqual(str(error.exception), f"API Error {mock_response.status_code}: The API call failed for some reason. Error: {mock_response.json()}")
